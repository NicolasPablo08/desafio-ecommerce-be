...
import { DataTypes, Model, InferAttributes, InferCreationAttributes, Op } from "sequelize";
    ...
    try {
      ...
      const carts = await Cart.findAll({
        where: {
          userId,
          status: {
            [Op.or]: ["pending", "finished", "approved"], // Usando Op.or para busqueda de múltiples estados
          },
        },
      });
      return carts;
